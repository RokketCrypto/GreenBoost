...
#define DEVICE_PATH "/dev/greenboost"
#define SYSFS_VRAM_INFO "/sys/class/greenboost/greenboost/vram_info"
...
void test_sysfs_directory(void) {
    ...
    const char *sysfs_dir = "/sys/class/greenboost";
    struct stat st;
...
int main(void) {
    printf("========================================\n");
    printf("Тест виртуальной видеокарты greenboost\n");
    printf("========================================\n\n");
