...
Использование: python3 test_greenboost.py
"""
...
def test_sysfs():
    ...
    vram_info_path = "/sys/class/greenboost/greenboost/vram_info"
...
def test_device():
    ...
    if os.geteuid() != 0:
        ...
        print("  Запустите: sudo python3 test_greenboost.py")
        return False
...
def test_sysfs_dir():
    ...
    sysfs_dir = "/sys/class/greenboost"
...
def main():
    print("=" * 50)
    print("Тест виртуальной видеокарты greenboost")
    print("=" * 50)
    print()
